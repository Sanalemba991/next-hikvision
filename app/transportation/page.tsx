            ...
            <motion.div className="space-y-8" variants={staggerContainer}>
              <motion.div variants={fadeInUp}>
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  Securing Transportation Excellence
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed">
                  Hikvision's transportation security solutions provide comprehensive protection for airports, railways, 
                  ports, and highways with advanced monitoring and intelligent traffic management systems.
                </p>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div className="text-center mb-12" variants={fadeInUp}>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Transportation Solutions</h2>
              <p className="text-xl text-gray-600">Comprehensive security and management solutions for all transportation sectors</p>
            </motion.div>
