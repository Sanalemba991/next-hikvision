            ...
            <motion.div className="space-y-4 md:space-y-6 lg:space-y-8 overflow-hidden" variants={staggerContainer}>
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-sm md:text-lg lg:text-xl text-gray-300 leading-relaxed">
                 Hikvision's industrial security solutions offer advanced protection for manufacturing facilities, warehouses, and critical infrastructure.
                </p>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          >
            <motion.div className="text-center mb-8 md:mb-12 overflow-hidden" variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4">Industrial Solutions</h2>
              <p className="text-lg md:text-xl text-gray-600">Comprehensive security and monitoring solutions for industrial applications</p>
            </motion.div>
