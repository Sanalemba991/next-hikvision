  ...
  const solutionCategories = [
    {
      ...
      description: 'Advanced perimeter security and facility monitoring systems designed for industrial environments.',
      solutions: [
    ...
    },
    {
      ...
      subtitle: 'AI-Powered Quality Control',
      description: 'Real-time monitoring and quality assurance systems to optimize production efficiency and safety.',
      solutions: [
    ...
    },
    {
      ...
      description: 'Intelligent warehouse operations with automated inventory tracking and logistics optimization.',
      solutions: [
    ...
    },
    {
      ...
      description: 'Specialized security solutions for power plants, oil refineries, and utility installations.',
      solutions: [
            ...
            <motion.div className="space-y-8" variants={staggerContainer}>
              <motion.div variants={fadeInUp}>
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  Securing Industrial Excellence
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed">
                  Hikvision's industrial security solutions provide comprehensive protection for 
                  manufacturing facilities, warehouses, and critical infrastructure with cutting-edge technology.
                </p>
              </motion.div>
          ...
          >
            <motion.div className="text-center mb-8" variants={fadeInUp}>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Why Choose Hikvision Industrial Solutions?
              </h2>
            </motion.div>
            <motion.div 
              ...
              {[
                {
                  ...
                  description: "60% reduction in security incidents and 45% improvement in operational efficiency",
                  color: "bg-red-600"
                },
                {
                  icon: Shield,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div className="text-center mb-12" variants={fadeInUp}>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Industrial Solutions</h2>
              <p className="text-xl text-gray-600">Comprehensive security and monitoring solutions for industrial applications</p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <iframe
                ...
                allowFullScreen
                title="Hikvision Industrial Solutions Demo"
              />
            </motion.div>
          </motion.div>
        )}
