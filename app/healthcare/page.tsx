            ...
            <motion.div className="space-y-4 md:space-y-6 lg:space-y-8 overflow-hidden" variants={staggerContainer}>
              <motion.div variants={fadeInUp}>
                ...
                <p className="text-sm md:text-lg lg:text-xl text-gray-300 leading-relaxed">
                 Hikvision's healthcare security solutions ensure patient safety, safeguard sensitive areas, and support medical staff with advanced monitoring and access control.
                </p>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          >
            <motion.div className="text-center mb-8 md:mb-12 overflow-hidden" variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4">Healthcare Solutions</h2>
              <p className="text-lg md:text-xl text-gray-600">Comprehensive security and monitoring solutions for healthcare facilities</p>
            </motion.div>
