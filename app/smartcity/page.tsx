  ...
  const solutionCategories = [
    {
      ...
      description: 'Advanced traffic control and monitoring systems for optimized urban mobility.',
      solutions: [
      ...
      image: 'https://images.unsplash.com/photo-1557223562-6c77ef16210f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'
    },
    {
      title: 'Public Safety & Security',
      subtitle: 'City-Wide Protection Network',
      description: 'Comprehensive security solutions for enhanced public safety and crime prevention.',
      solutions: [
    ...
    },
    {
      ...
      description: 'IoT-based environmental monitoring for sustainable city development.',
      solutions: [
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            <motion.div className="space-y-4 md:space-y-6 lg:space-y-8 overflow-hidden" variants={staggerContainer}>
              <motion.div variants={fadeInUp}>
                ...
                >
                  <Building className="w-3 h-3 md:w-4 md:h-4 mr-1.5 md:mr-2" />
                ...
                <p className="text-sm md:text-lg lg:text-xl text-gray-300 leading-relaxed">
                  Hikvision's integrated smart city solutions leverage AI, IoT, and big data 
                  to create safer, more efficient, and sustainable urban environments.
                </p>
              </motion.div>
          ...
          >
            <motion.div className="text-center mb-6 md:mb-8" variants={fadeInUp}>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 md:mb-4">
                Why Choose Hikvision Smart City Solutions?
              </h2>
            </motion.div>
            <motion.div 
              ...
              {[
                {
                  ...
                  description: "70% crime reduction and 40% traffic improvement in deployed cities",
                  color: "bg-red-600"
                },
                {
                  icon: Shield,
                ...
                },
                {
                  icon: Globe,
                  title: "Global Scale",
                  description: "Deployed in 500+ cities worldwide with 24/7 support",
                  color: "bg-red-600"
                }
              ].map((benefit, index) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          >
            <motion.div className="text-center mb-8 md:mb-12 overflow-hidden" variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4">Smart City Solutions</h2>
              <p className="text-lg md:text-xl text-gray-600">Comprehensive solutions for modern urban challenges</p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <iframe
                ...
                allowFullScreen
                title="Hikvision Smart City Demo"
              />
            </motion.div>
          </motion.div>
        )}
