        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div className="text-center mb-12" variants={fadeInUp}>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Smart City Solutions</h2>
              <p className="text-xl text-gray-600">Comprehensive solutions for modern urban challenges</p>
            </motion.div>
