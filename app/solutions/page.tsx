      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="relative z-10 px-4 md:px-10 py-6 md:py-8 text-white w-full flex flex-col justify-center">
                  <div className="flex flex-col md:flex-row md:items-center mb-3 md:mb-4">
                    <span className="px-3 py-1 bg-red-600 text-white text-xs font-semibold rounded-full mb-2 md:mb-0 md:mr-4 w-fit">
                      {categories.find(cat => cat.id === filteredSolutions[0].category)?.name}
                    </span>
                    <h2 className="text-xl md:text-3xl font-bold">{filteredSolutions[0].title}</h2>
                  </div>
                  <p className="text-sm md:text-lg mb-4 md:mb-6 leading-relaxed">{filteredSolutions[0].description}</p>
                  
                  {/* Responsive features display */}
          ...
          <motion.div
            ...
            variants={slideUp}
          >
            <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-100 rounded-2xl p-6 md:p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  className="inline-flex items-center px-6 md:px-8 py-3 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-colors text-sm md:text-base"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
